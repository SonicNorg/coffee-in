...
Revision ID: ccdf67f7060a
Revises: 
Create Date: 2019-03-02 21:08:09.285014
...
def upgrade():
    ...
    sa.Column('coffee_type', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['coffee_type'], ['coffee_prices.id'], ),
